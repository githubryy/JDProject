...
get(url).then((res) => {
    ...
    $sex.val(res.data[0].sex?res.data[0].sex:1)
    $email.val(res.data[0].email)
    $selfIntroduce.val(res.data[0].self_introduce)
    $img1Edit.attr('src', res.data[0].userImgurl?res.data[0].userImgurl:"media/image/avitor.png")
    $img2Edit.attr('src', res.data[0].userImgurl?res.data[0].userImgurl:"media/image/avitor.png")
    $img3Edit.attr('src', res.data[0].userImgurl?res.data[0].userImgurl:"media/image/avitor.png")
